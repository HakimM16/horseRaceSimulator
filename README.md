...
4. ▶️ For Part 1, cd into Part 1 by typing `cd Part 1` in terminal, type and enter `javac startRace.java` then type `java startRace` to compile and run the `startRace.java` file to start the application.
